# Creating SVG lines around product

First create svg horizontal and vertical line
...
second: define common classes to limit its height and width
...
Third: apply classes and add new to each
