...
import {  productFeature } from "../constants";
...
const ProductFeature  = async ( ) => {
  ...
  const formattedPrice = formatPrice(+productFeature?.price);
    ...
    >
      <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-3 lg:grid-rows-[auto,auto]">
        ...
        >
          ...
          <Image 
          src={productFeature.featuredImage.src}
          alt=""
          width={productFeature.featuredImage.width}
          height={productFeature.featuredImage.height}
        ...
        >
          <Image
          src={productFeature.image.src}
          width={productFeature.image.width}
          height={productFeature.image.height}
            alt=""
